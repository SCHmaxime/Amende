...
<body>
    <header>
    <div class="container">
        <p>Page suppression d'une ardoise</p>
        <div class="block">
            <div class="entete-bg">
                <div class="entete">
        ...
        <h1>Formulaire de suppression d'une ardoise</h1>
        <form action="supprimer_ardoise.php" method="get">
            ...
            <input class="new_ardoise_bouton" type="submit" value="Supprimer l'ardoise">
        </form>
